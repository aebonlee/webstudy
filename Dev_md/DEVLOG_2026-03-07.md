...
### 8. CSS 스타일 추가
- Family Site 드롭다운 스타일 (위로 펼쳐지는 팝업 방식)
- footer-bottom-inner / footer-bottom-item / footer-bottom-sep 스타일
- 모바일 반응형: 768px 이하에서 구분자(|) 숨김, 세로 나열

## 빌드 결과
- index.html: 2.08 kB
- CSS: 23.35 kB (gzip: 4.86 kB)
- JS: 301.36 kB (gzip: 95.63 kB)
- 빌드 시간: 4.04s
